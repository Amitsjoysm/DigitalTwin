...
### Manual Testing
1. Visit: `https://digitaltwinai.preview.emergentagent.com`
2. Create account
...
```bash
# Health check
curl https://digitaltwinai.preview.emergentagent.com/api/health

# Register
curl -X POST https://digitaltwinai.preview.emergentagent.com/api/auth/register \
